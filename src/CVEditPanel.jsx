...
function CVEditPanel({ personalInfo, experience, education, currentMode, handlePersonalFieldChange, handleExperienceVisibilityToggle, handleEducationVisibilityToggle, handleExperienceSave, handleEducationSave, handleExperienceDelete, handleEducationDelete, onLayoutChange, color, onColorChange }) {
    ...
    return (
        <div className="cv-edit-panel">
            ...
            {currentMode === 'customize' && <CVCustomize onLayoutChange={onLayoutChange} color={color} onColorChange={onColorChange} />}
        </div>
    )
}
